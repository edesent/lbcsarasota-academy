  ...
  return (
    <section id="give" className="py-28 bg-cream">
      <div className="max-w-7xl mx-auto px-6">
        <SectionBadge
          number={16}
          name="Give / Online Giving CTA"
          purpose="A clear way for members to give tithes and offerings online"
        />
            ...
            <div className="relative grid md:grid-cols-[1fr_auto] gap-10 items-center">
              <div>
                ...
                <p className="text-white/80 leading-relaxed max-w-xl mb-3">
                  Your tithes and offerings support the ongoing ministry of Liberty Baptist Church —
                  the preaching of the Gospel here in Sarasota and our missionaries around the world.
                  Give securely online, or drop your offering in the plate Sunday morning.
                </p>
